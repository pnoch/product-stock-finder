...
describe("timelineSegments", () => {
  ...
  it("weights are proportional to time gaps", () => {
    ...
    // spans: 1h, 2h -> total 3h, extended 5h -> weights 0.2, 0.4, 0.4
  ...
  it("last segment reuses the previous span", () => {
    ...
    // spans: 1h -> total 1h, extended 2h -> weights 0.5, 0.5
  ...
  it("weights sum to 1 with extended denominator", () => {
    const segments = timelineSegments([
      sample("working", "2026-08-01T00:00:00Z"),
    ...
    // spans 2h,1h,2h total 5h, extended 7h -> weights 2/7,1/7,2/7,2/7 sum 1
