    ...
    for product in products {
        for distributor_id in product.distributor_ids {
            ...
            let scrape_result = match distributor_id.as_str() {
                ...
                "nasstore-eu" => scrapers::nasstore::scrape(&product.model_number).await,
                "aerial-gr" => scrapers::aerial::scrape(&product.model_number).await,
                "mikrotikstore-de" => scrapers::mikrotikstore::scrape(&product.model_number).await,
                "miro-za" => scrapers::miro::scrape(&product.model_number).await,
                "gearup-ae" => scrapers::gearup::scrape(&product.model_number).await,
                "balticnetworks-us" => scrapers::balticnetworks::scrape(&product.model_number).await,
                "linktechs-us" => scrapers::linktechs::scrape(&product.model_number).await,
                "winncom-us" => scrapers::winncom::scrape(&product.model_number).await,
                "bhphoto-us" => scrapers::bhphoto::scrape(&product.model_number).await,
                "duxtel-au" => scrapers::duxtel::scrape(&product.model_number).await,
                "wisp-au" => scrapers::wisp::scrape(&product.model_number).await,
                "pbtech-nz" => scrapers::pbtech::scrape(&product.model_number).await,
                "gowifi-nz" => scrapers::gowifi::scrape(&product.model_number).await,
                "getic-gr" => scrapers::getic::scrape(&product.model_number).await,
                "100mega-cz" => scrapers::mega::scrape(&product.model_number).await,
                "hellascom-gr" => scrapers::hellascom::scrape(&product.model_number).await,
                "rocnoc-us" => scrapers::rocnoc::scrape(&product.model_number).await,
                "networkdevices-us" => scrapers::networkdevices::scrape(&product.model_number).await,
                "flytec-us" => scrapers::flytec::scrape(&product.model_number).await,
                "mbsiwav-ca" => scrapers::mbsiwav::scrape(&product.model_number).await,
                "multilink-us" => scrapers::multilink::scrape(&product.model_number).await,
                "neobits-us" => scrapers::neobits::scrape(&product.model_number).await,
